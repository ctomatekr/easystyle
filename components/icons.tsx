...
export const EasyStyleLogo: React.FC<{ className?: string }> = ({ className }) => (
  <div className={`flex items-center gap-3 ${className}`}>
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-sky-400">
      {/* Clothing Hanger Shape */}
      <path 
        d="M8 12 C8 12, 12 8, 20 8 C28 8, 32 12, 32 12" 
        stroke="currentColor" 
        strokeWidth="2.5" 
        strokeLinecap="round" 
      ...
      {/* Hanger Hook */}
      <path 
        d="M20 8 L20 4 C20 3, 19 2, 18 2 C17 2, 16 3, 16 4" 
        stroke="currentColor" 
        strokeWidth="2.5" 
        strokeLinecap="round" 
        strokeLinejoin="round"
      ...
      {/* Clothing Silhouette */}
      <path 
        d="M8 12 L8 16 C8 16, 10 18, 12 20 L12 32 C12 34, 14 36, 16 36 L24 36 C26 36, 28 34, 28 32 L28 20 C30 18, 32 16, 32 16 L32 12" 
        stroke="currentColor" 
        strokeWidth="2" 
        strokeLinecap="round" 
        strokeLinejoin="round"
      ...
      {/* Checkmark inside clothing */}
      <path 
        d="M16 22 L19 25 L24 20" 
        stroke="#FFD700" 
        strokeWidth="2.5" 
        strokeLinecap="round" 
        strokeLinejoin="round"
      ...
      <circle cx="23" cy="16" r="1" fill="#FFA500"/>
    </svg>
    <span className="text-2xl font-bold text-slate-100 tracking-tight" style={{ fontFamily: 'Quicksand, sans-serif' }}>
      EasyStyle
    </span>
  </div>
);
...
export const RadioButtonIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const KakaoIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}>
        <path fill="#000000" d="M12 3C7.03 3 3 6.21 3 10.11c0 2.44 1.62 4.59 4.06 5.82L6.31 19.4c-.14.35.22.69.56.48l3.33-2.17c.58.08 1.18.12 1.8.12 4.97 0 9-3.21 9-7.11S16.97 3 12 3z"/>
    </svg>
);